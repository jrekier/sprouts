...
(* list of scalar fields *)
Sprouts`scalars={{\[Delta]\[Phi]1,pol1},{\[Delta]\[Phi]2,pol2}};
(* layer 1 *)
Rank[pol1]^=0;
...
\[CapitalDelta]\[Sigma]1\[DotEqual]((-1)\[Star]p1\[CircleTimes]\[DoubleStruckG])\[CirclePlus](2\[Star](\[Mu]c\[Star]SymmetricTraceless[\[Del]S1]))
\[Delta]\[Rho]1\[DotEqual](-1)\[Star](TDiv[(\[Rho]01\[CircleTimes]S1)])
ClearAll[\[CapitalDelta]\[Sigma]2,\[Delta]\[Rho]2]
\[CapitalDelta]\[Sigma]2\[DotEqual]((-1)\[Star]p2\[CircleTimes]\[DoubleStruckG])\[CirclePlus](2\[Star](\[Mu]m\[Star]SymmetricTraceless[\[Del]S2]))
...
Sprouts`\[ScriptCapitalO]d={{2,4},{2,4}};
...
Flatten@Table[Numerator[Together[Component[ProjectESD[(\[CapitalDelta]\[Sigma]1\[CircleMinus]\[CapitalDelta]\[Sigma]2),\[DoubleStruckCapitalN][\[CurlyEpsilon]],\[CurlyEpsilon]],List[rad],List[\[ScriptL],\[ScriptM]]][r]]],{\[ScriptL],\[ScriptL]min,\[ScriptL]max},{\[ScriptM],Max[\[ScriptM]min,-\[ScriptL]],Min[\[ScriptM]max,\[ScriptL]]}]/.rulep1/.rulep2,
...
Flatten@Table[Numerator[Together[Component[ProjectESD[\[CapitalDelta]\[Sigma]2,\[DoubleStruckCapitalN][\[CurlyEpsilon]],\[CurlyEpsilon]],List[rad],List[\[ScriptL],\[ScriptM]]][r]]],{\[ScriptL],\[ScriptL]min,\[ScriptL]max},{\[ScriptM],Max[\[ScriptM]min,-\[ScriptL]],Min[\[ScriptM]max,\[ScriptL]]}]/.rulep2,
...
parameters={\[Omega] -> 1, G -> 2.220827678651735`*^6, \[Rho]c -> 0.3186194390744936`, \[Mu]c -> 1.0822995451780425`, \[Rho]m -> 0.14081340958218241`, \[Mu]m -> 757609.6816246298`};
